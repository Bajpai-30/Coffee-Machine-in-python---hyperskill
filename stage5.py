...
def buy():
    ...
    try:
        if flavor == 0:
            ...
            is_enough(need_water=350, need_milk=75, need_coffee=20)
            ...
            is_enough(need_water=200, need_milk=100, need_coffee=12)
...
def fill():
    ...
    beans += int(input('Write how many grams of coffee'
                       ' do you want to add: '))
